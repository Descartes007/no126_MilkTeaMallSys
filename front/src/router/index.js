...
const routes = [
    //前台
  {
    ...
    meta: {title:'奶茶售卖系统', path: '奶茶售卖系统', requireAuth: false},
    children: [
      {path: 'person', name: 'person', meta: {title:'个人信息',requireLogin: true}, component: () => import('../views/Person.vue'),},
      {path: 'topview', name: 'topview', meta: {title:'奶茶售卖系统'}, component: () => import('../views/front/TopView.vue'),},
      {path: 'cart', name: 'cart', meta: {title:'我的购物车',requireLogin: true}, component: () => import('../views/front/good/Cart.vue'),},
      {path: 'goodList', name: 'goodList', meta: {title:'饮品界面'}, component: () => import('../views/front/good/GoodList.vue'),},
      {path: 'goodView/:goodId', name: 'goodview', meta: {title:'饮品详情'}, component: () => import('../views/front/good/GoodView.vue'),},
    ...
    //后台
  {
    ...
    children: [
      ...
      {path: 'carousel', name: 'carousel', meta: {title:'轮播图管理',path: '饮品/轮播图管理',requireAuth: true}, component: () => import('../views/manage/good/Carousel.vue'),},
      {path: 'category', name: 'category', meta: {title:'饮品分类管理',path: '饮品/饮品分类管理',requireAuth: true}, component: () => import('../views/manage/good/Category.vue'),},
      {path: 'good', name: 'good', meta: {title:'饮品管理',path: '饮品/饮品管理',requireAuth: true}, component: () => import('../views/manage/good/Goods.vue'),},
      {path: 'goodInfo', name: 'goodInfo', meta: {title:'饮品管理',path: '饮品/饮品管理/饮品信息',requireAuth: true}, component: () => import('../views/manage/good/GoodInfo.vue'),},
      {path: 'order', name: 'order', meta: {title:'订单管理',path: '饮品/订单管理',requireAuth: true}, component: () => import('../views/manage/Order.vue'),},
