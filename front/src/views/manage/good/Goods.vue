<template>
  <div>
    ...
    <el-table :data="tableData" border stripe style="width: 100%">
      <el-table-column prop="id" label="饮品id" width="80px"></el-table-column>
      <el-table-column prop="name" label="饮品名称"></el-table-column>
      <el-table-column label="饮品图片" width="120px">
        <template slot-scope="scope">
          <img :src="baseApi + scope.row.imgs" style="width: 90px;height: 80px">
        </template>
      </el-table-column>
      <el-table-column prop="description" label="饮品描述" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="dialogFormVisible" width="30%"
      ...
      <el-form :model="entity">
        <el-form-item label="饮品名称" label-width="150px">
          <el-input v-model="entity.name" autocomplete="off" style="width: 80%"></el-input>
        </el-form-item>
        <el-form-item label="饮品描述" label-width="150px">
        ...
        <el-form-item label="饮品图片" label-width="150px">
          <el-upload
              class="upload-demo"
              ref="upload"
